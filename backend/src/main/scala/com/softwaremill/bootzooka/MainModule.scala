...
import com.softwaremill.bootzooka.languages.LanguagesModule
...
trait MainModule
  ...
  private lazy val endpoints: ServerEndpoints = userApi.endpoints concatNel passwordResetApi.endpoints concatNel languagesApi.endpoints
